                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="form-validation">
                                <div class="preview">
                                    <form method="POST" action="{{ route('updatedUser', $editUser->id) }}" enctype="multipart/form-data">
                                      @csrf
                                        ...
                                        <div class="input-form mt-3">
                                            ...
                                            <input type="text" name="firstName" class="input w-full border mt-2" value="{{ $editUser->first_name }}">
                                        </div>

                                        <div class="input-form mt-3">
                                            <label class="flex flex-col sm:flex-row">Last Name</label>
                                            <input type="text" name="lastName" class="input w-full border mt-2" value="{{ $editUser->last_name }}">
                                        </div>

                                        <div class="input-form mt-3">
                                            <label class="flex flex-col sm:flex-row">Email</label>
                                            <input type="email" name="email" class="input w-full border mt-2" value="{{ $editUser->email }}">
                                        </div>
                                        ...
                                        <div class="input-form mt-3">
                                          ...
                                          <div class="mt-2">
                                            <select class="tail-select w-full" name="role">
                                              ...
                                              <option value="{{ $role->id }}" {{ old('role_id', $editUser->role_id) == $role->id ? 'selected' : '' }}>{{ $role->role_name }}</option>
                                              @endforeach
                                            </select>
                                          </div>
                                        </div>
