                  ...
                  <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                      <div class="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                          ...
                          <div class="intro-x mt-8">
                              <input id="name" type="text" class="intro-x login__input input input--lg border border-gray-300 block" name="first-name" value="{{ old('first-name') }}" autocomplete="name" autofocus placeholder="First Name">

                              <input id="name" type="text" class="intro-x login__input input input--lg border border-gray-300 block mt-4"  name="last-name" value="{{ old('last-name') }}" autocomplete="name" autofocus placeholder="Last Name">

                              <input id="email" type="email" class="intro-x login__input input input--lg border border-gray-300 block mt-4" name="email" value="{{ old('email') }}" autocomplete="email" placeholder="Email">

                              <input id="password" type="password" class="intro-x login__input input input--lg border border-gray-300 block mt-4" name="password" autocomplete="new-password" placeholder="Password">
                              ...
                              <input id="password-confirm" type="password" class="intro-x login__input input input--lg border border-gray-300 block mt-4" name="password_confirmation" autocomplete="new-password" placeholder="Password Confirmation">
